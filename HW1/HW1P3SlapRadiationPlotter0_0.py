...
def plot_xyz_positions(x_arr, y_arr, z_arr):
	fignamestring = "X_YpositionsAJan25.png"
...
for i in range(0, trial_iterations):
	...
	while radius_fr < R_final_fr:
		...
		distance_init = (x_val_init**2. + y_val_init**2. + z_val_init**2.)**(1./2.)  #Calculate the vector length for values.
